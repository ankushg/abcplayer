...
public class LexerTest {
    ...
    public void testLyrics() {
        ...
        int[] tokenTypes = { LYRIC_START, WHITESPACE, NONBASENOTE, BASE, LYRIC_SEPARATOR, NONBASENOTE, NONBASENOTE,
                WHITESPACE, NONBASENOTE, NONBASENOTE, WHITESPACE, BASE, NONBASENOTE, LYRIC_SEPARATOR, NONBASENOTE,
                ...
                NONBASENOTE, LYRIC_MODIFIER, NONBASENOTE, BASE, WHITESPACE, BASE, NONBASENOTE, NONBASENOTE, BASE,
                WHITESPACE, NONBASENOTE, NONBASENOTE, WHITESPACE, NONBASENOTE, NONBASENOTE, BASE, WHITESPACE,
                NONBASENOTE, BASE, LYRIC_SEPARATOR, NONBASENOTE, LYRIC_SEPARATOR, NONBASENOTE, BASE, NONBASENOTE,
                WHITESPACE, BASE, BASE, NONBASENOTE, LYRIC_SEPARATOR, BASE, NONBASENOTE, BASE, PUNCTUATION, };
